...
{
    public class InspOrderListItem : MonoBehaviour
    {
        ...
        private static readonly LocalizedStyle PriorityStyle =
            LocalizedStyle.LabelLocalized | LocalizedStyle.ValueLocalized | LocalizedStyle.LabelColored | LocalizedStyle.ValueColored | LocalizedStyle.Indent;
        ...
        public void UpdateListItem(EqptOrder order)
        {
            ...
            sb.AppendLine(MakeLocalizedInfoRichText("T_InspItems", order.Description));
            ...
            sb.AppendLine(MakeLocalizedInfoRichText("T_CheckForm", order.Forms));
            sb.AppendLine(MakeLocalizedInfoRichText("T_InspDate", order.ScheduledDate));
            ...
            string buttonActionKey = isCompleted ? "BTN006" : "T_s_Insp";
