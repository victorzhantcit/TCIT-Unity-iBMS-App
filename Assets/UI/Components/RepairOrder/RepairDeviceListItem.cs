...
{
    public class RepairDeviceListItem : MonoBehaviour, IObjectPoolItem<RepairDeviceItemData>
    {
        [Serializable]
        ...
        /// <inheritdoc/>
        public void Bind(RepairDeviceItemData bindingReference, bool isDisabled)
        {
